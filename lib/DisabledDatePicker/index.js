...
var DisabledDatePicker = _wrapComponent('_component')(_react3.default.createClass({
	...
	render: function render() {
		...
		return _react3.default.createElement(_antd.DatePicker, { disabledDate: this.disabledDate, onChange: onChange, value: value, placeholder: placeholder, style: style });
	}
}));
